...
## ✅ Done (완료)
- [x] **`1.교육자료/기본_AI 이해/2. AI의_이해.md` 1.4절 서사 연결성 및 멘탈 모델 개선** (2026-08-28)
  - 📚 **학습 목표**: "숫자 변환 ➔ 고정된 가중치(레시피) 계산 ➔ 후보별 확률 출력"의 3단계 인과관계 서사를 구축하여 비전공자의 딥러닝 본질 이해를 돕고 1.5절(토큰화/자기회귀)로의 인지적 연결 강화
